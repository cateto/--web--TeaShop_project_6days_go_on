...
<script>
	...
	$(document).on('click', '#btnList', function(){
		...
		location.href = "board.do?m=list&cp=1&ps=3";
...
<%	
    ArrayList<Board> contents = (ArrayList<Board>)request.getAttribute("contents");
...
%>
		...
		<div class="container" role="main">
			...
			<div class="bg-white rounded shadow-sm">
				...
				<div class="board_title"><c:out value="<%=board.getB_subject()%>"/></div>

				<div class="board_info_box">

					<span class="board_author"><c:out value="관리자"/>, </span><span class="board_date"><c:out value="<%=board.getB_date()%>"/></span>

				</div>

				<div class="board_content"><%=board.getB_content()%></div>
