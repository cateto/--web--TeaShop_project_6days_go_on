<%@page contentType="text/html;charset=utf-8" import="domain.Member"%>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            <h2 class="h3 mb-3 text-black font-heading-serif">PROFILE</h2>
		 ...
		 <form name="f" action="member.do?m=update" method="post">
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <input readOnly class="form-control"  id="id" name="id" value="<%=member.getM_id()%>">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="birth" name="birth" value="<%=member.getM_birth()%>" data-provide="datepicker" data-date-format="yyyy-mm-dd">
                </div>
              </div>
              ...
              <div class="form-group row mb-5">
                ...
                <input type="text" class="form-control" id="postalcode" name="postalcode" value="주소 수정 시 클릭" onclick="Postcode()">
              </div>     
                  
                  <input readOnly type="text" class="form-control" id="addr" name="addr"  value="<%=member.getM_addr()%>">
                </div>
              </div>
    
              <div class="form-group">
                <input readOnly type="text" class="form-control" id="addr2" name="addr2" value="<%=member.getM_addr2()%>">
              </div>   
              
              <div class="form-group row">
                      <div class="col-md-12">
                          <input type="button" value="Edit" class="btn btn-primary py-3 px-5" onkeydown="check()" onclick="check()">
                      </div>
                  </div> 
                  </br></br>
             	탈퇴를 원하시면 <u></u><a href="member.do?m=out">여기</a></u>를 클릭하세요.
                  </form>           
              </div>
